...
@section('content')
    ...
    <section class="add-result-section">
        ...
        <form id="add-result-form" class="admin-form"
            action="{{ route('admin.beshmingm.update', parameters: $beshmingm->id) }}" method="POST"
            ...
            <div class="form-group">
                ...
                <input name="name" id="name" type="text" placeholder="Isim kiriting" required
                    value="{{ $beshmingm->name }}">
            </div>
            ...
            <div class="form-group">
                ...
                <select name="gender" id="gender" class="form-control" required>
                    <option value="male" {{ old('gender', $beshmingm->gender) == 'male' ? 'selected' : '' }}>O'g'il bola
                    </option>
                    <option value="female" {{ old('gender', $beshmingm->gender) == 'female' ? 'selected' : '' }}>Qiz
                        bola</option>
                </select>
            </div>
