            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <select name="gender" id="gender" class="form-control" required>
                    <option value="male" {{ old('gender', $birmingbeshyuzm->gender) == 'male' ? 'selected' : '' }}>O'g'il bola</option>
                    <option value="female" {{ old('gender', $birmingbeshyuzm->gender) == 'female' ? 'selected' : '' }}>Qiz bola</option>
                </select>
            </div>
